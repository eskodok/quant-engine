...
- GAGAL: timing entry tidak lebih baik dari acak (persentil 34 < 75): hasil = arus pasar, bukan sinyal
- PERINGATAN: PBO 0.39 agak tinggi
- PERINGATAN: Sharpe OOS -0.55 < buy&hold 0.33: belum lebih baik dari sekadar memegang aset
...
- Timing vs entry acak: persentil 34 (harus >= 75)
- Probability of Backtest Overfitting (CSCV): 0.39 (harus < 0.5)
- Buy & hold jendela OOS: return +16.2%, Sharpe 0.33, maxDD -44.3% | strategi: return -3.1%, Sharpe -0.55, maxDD -5.4%
